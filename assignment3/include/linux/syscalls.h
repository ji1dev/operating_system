...
asmlinkage long sys_calc_plus(int, int, int*);
asmlinkage long sys_calc_minus(int, int, int*);
asmlinkage long sys_calc_mul(int, int, int*);
asmlinkage long sys_calc_mod(int, int, int*);
